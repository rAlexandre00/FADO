    ...
    def __init__(
        ...
        if self.dataset is not None:
            ...
            self.train_loader = DataLoader(
                dataset=TensorDataset(self.dataset[0], target), batch_size=3, shuffle=True, num_workers=2,
            )
